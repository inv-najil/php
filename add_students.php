    ...
    <div class="container">
        <div class="row justify-content-center align-items-center min-vh-100">
            <div class="col-11 col-sm-8 col-md-6 col-lg-4">
                <h1 class="text-center mb-4">Register student</h1>
                <form action="register.php" method="post">
                    <label for="name" id="name" class="form-label">Enter Name</label>
                    <input type="text" id="name" class="form-control" placeholder="enter student name" name="name"
                        required>
                    <label for="registartion_number" id="reg_num" class="form-label">Enter Registartion
                        Number</label>
                    <input type="text" id="registartion_number" class="form-control" placeholder="format: REG-YYYY-NNNN"
                        name="reg_num" required>
                    ...
                    <input type="email" id="email" class="form-control mb-4" placeholder="Enter email id" name="email"
                        required>
                    <select id="course" class="form-control mb-4" name="course">
